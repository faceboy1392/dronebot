...
class Impl extends Executable {
  async execute(bot: Bot, interaction: ChatInput) {
    ...
    .setComponents(
      ...
      .setURL("https://discord.com/api/oauth2/authorize?client_id=1060614689173807225&permissions=34816&scope=bot%20applications.commands"),
      new ButtonBuilder()
      .setLabel("GitHub")
      .setStyle(ButtonStyle.Link)
      ...
      .setLabel("Bob Bot")
      .setStyle(ButtonStyle.Link)
      .setURL("https://discord.gg/33Aw6gWmmV")
    )
